...
#ifndef SPARSE_MERKLE_TREE_CHECK_READ_GADGET_HPP_
#define SPARSE_MERKLE_TREE_CHECK_READ_GADGET_HPP_
...
class sparse_merkle_tree_check_read_gadget : public gadget<FieldT> {
private:
...
public:
    ...
    sparse_merkle_tree_check_read_gadget(protoboard<FieldT> &pb,
                                  const size_t tree_depth,
...
template<typename FieldT, typename HashT>
void test_sparse_merkle_tree_check_read_gadget();

} // gunero

#include "sparse_merkle_tree_check_read_gadget.tcc"

#endif // SPARSE_MERKLE_TREE_CHECK_READ_GADGET_HPP_
